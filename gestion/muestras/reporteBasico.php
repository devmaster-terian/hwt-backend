...
$objPHPExcel->getActiveSheet()
    ...
    ->setCellValue('C3', 'Nombre del Reporte')
    ->setCellValue('C4', $strFecha);

$objPHPExcel->getActiveSheet()
    ->getStyle('C1')->applyFromArray($estiloTitulo);

$objPHPExcel->getActiveSheet()
    ->getStyle('C3')->applyFromArray($estiloReporte);

$objPHPExcel->getActiveSheet()
    ->getStyle('C4')->applyFromArray($estiloFecha);
