...
describe("Ext.form.field.ComboBox", function() {
    ...
    describe("displayTpl", function() {
        describe("should create default", function() {
            ...
            it("displayTpl should be an XTemplate", function() {
                expect(combobox.displayTpl.isTemplate).toBe(true);
            });

            it("displayTpl html match", function() {
                expect(combobox.displayTpl.html).toBe('<tpl for=".">{[typeof values === "string" ? values : values["text"]]}<tpl if="xindex < xcount">, </tpl></tpl>');
            });
        ...
        describe("should create from string", function () {
            ...
            it("displayTpl html match", function () {
                expect(combobox.displayTpl.html).toBe('<tpl for=".">{[typeof values === "string" ? values : values["foo"]]}</tpl>');
            });
    ...
    // displayField !== valueField
        ...
        it("should not collapse while typing and it matches a record", function() {
            ...
            waitsFor(function(){
                return component.getStore().getCount() > 1;
            });

            runs(function(){
                doTyping('A1', false, true);
            });

            waitsFor(function(){
                return panel.getViewModel().get('name') == 'A1';
            },'Syncing combobox with ViewModel');
        ...
        it("should not clear the combobox while typing and forceSelection is true", function() {
            ...
            runs(function(){
                component.setValue(2);
                doTyping('1', false, true);
            });

            waitsFor(function(){
                return !panel.getViewModel().get('address');
            });

            runs(function(){
                expect(component.inputEl.dom.value).toBe('1');
            });
        });
    ...
    describe("forceSelection: true", function() {
        ...
        it("should not select the lastSelectedValue after a new value has been set", function() {
            ...
            waitsFor(function() {
                return component.hasFocus;
            }, 'combobox to focus for the second time');
