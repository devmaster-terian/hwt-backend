describe("Ext.tree.Panel", function(){
    ...
    describe("cellediting", function() {
        it("should be able to edit a cell by passing row number and column number", function() {
            makeTree(null, {
                plugins: ['cellediting'],
                columns: [{
                    xtype: 'treecolumn',
            ...
            tree.normalGrid.findPlugin('cellediting').startEdit(0, 0);

            expect(tree.normalGrid.findPlugin('cellediting').editing).toBe(true);
        });
    });
});
