...
describe("Ext.window.Window", function() {
    ...
    describe('nested Windows', function() {
        it('should disable tabbing in tha parent window', function() {
            ...
            // Three buttons in the body.
            expect(win1.el.findTabbableElements().length).toBe(3);
            ...
            // Three buttons, two input fields in the body.
            expect(win2.el.findTabbableElements().length).toBe(5);
