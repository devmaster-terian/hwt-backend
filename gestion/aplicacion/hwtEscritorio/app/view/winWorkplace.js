...
Ext.define('hwtEsritorio.view.winWorkplace', {
                                    ...
                                    items: [
                                        {
                                            ...
                                            cls: 'botonZoom',
                                            height: 45,
                                            id: 'btnProPedidoVentas1',
                                            itemId: 'btnProPedidoVentas',
                                            margin: '10 10 10 10',
                                            maxWidth: 170,
                                            iconCls: 'fa fa-check-square-o fa-lg icono-blanco icon24',
                                            text: 'Solicitud de Toma</br>de Unidades',
                                            textAlign: 'left',
                                            listeners: {
                                                click: 'onBtnProPedidoVentasClick1'
                                            }
                                        }
                                    ]
                                }
    ...
    onBtnProPedidoVentasClick1: function(button, e, eOpts) {
        var msgTipo = 'information';
        var msgTitulo = 'Proceso de Pedidos de Venta';
