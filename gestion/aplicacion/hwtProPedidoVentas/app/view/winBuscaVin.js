...
Ext.define('hwtProPedidoVentas.view.winBuscaVin', {
    extend: 'Ext.window.Window',
    alias: 'widget.winBuscaVin',

    requires: [
        'hwtProPedidoVentas.view.winBuscaVinViewModel',
        'Ext.form.Panel',
        'Ext.form.FieldSet',
    ...
    onCbxFiltroMarcaChange: function(field, newValue, oldValue, eOpts) {
